...
(()=>{
    const e = new Error("Cannot find module './../../../assets/styles/__variables.module.scss'");
...
const Input = ({ placeholder, name, value, type = 'text', additionalClass = '', icon, iconPosition, breakpoint, maxLen, error, onChange })=>{
    ...
    const iconColor = {
        strokeColor: isHovered ? cssVars.neutral_400 : value?.length === 0 ? cssVars.neutral_600 : cssVars.white,
        fillColor: 'none'
    };
...
//# sourceMappingURL=src_0y554ib._.js.map