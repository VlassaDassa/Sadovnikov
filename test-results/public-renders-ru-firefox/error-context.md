...
- Array []
+ Array [
+   "[JavaScript Error: \"Cookie “metrika_enabled” has been rejected for invalid domain.\" {file: \"http://127.0.0.1:3000/ru\" line: 0}]",
+   "[JavaScript Error: \"Cookie “metrika_enabled” has been rejected for invalid domain.\" {file: \"http://127.0.0.1:3000/ru\" line: 0}]",
+ ]
```
      ...
      - list [ref=e33]:
        - listitem [ref=e34]:
          - link "контакты" [ref=e35] [cursor=pointer]:
            - /url: /ru#contacts
        - listitem [ref=e36]:
          - link "обо мне" [ref=e37] [cursor=pointer]:
            - /url: /ru#about
        - listitem [ref=e38]:
          - link "портфолио" [ref=e39] [cursor=pointer]:
            - /url: /ru#portfolio
        - listitem [ref=e40]:
