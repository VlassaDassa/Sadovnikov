...
const Evolution:
    React.FC<EvolutionProps> = ({
        ...
        async function handleGenerate():
            ...
            if (!hasGithubLink) {
                setError(
                    'GitHub repository link is missing',
                );
                    ...
                    >
                        ...
                        {generationInfo && (
                            ...
                            >
                                Loaded{' '}
                                {
                                    generationInfo.totalCommits
                                }{' '}
                                commits.
                                Analyzed{' '}
                                {
                                    generationInfo.analyzedCommits
                                }
                                .
                            </div>
                        )}
