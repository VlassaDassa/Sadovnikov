...
const EvolutionReviewModal: React.FC<
...
> = ({
    ...
    const isEvolutionReviewModalOpen =
        useSelector(
            (state: RootState) =>
                state.uiState
    ...
    function updateItem(
        id: string,
        patch: Partial<IEvolutionDraftItem>,
    ): void {
        setItems(
            (
                currentItems,
