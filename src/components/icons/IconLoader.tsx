       ...
       <svg width={size} height={size} viewBox={`0 0 64 64`} className={iconClass} xmlns="http://www.w3.org/2000/svg">
        ...
        <defs>
            <clipPath id="clip0_105_300">
                <rect width={size && size*3} height={size && size*3}/>
            </clipPath>
        </defs>
        </svg>
