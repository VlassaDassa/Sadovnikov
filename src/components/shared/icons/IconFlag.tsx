...
const IconFlag: React.FC<IconItem> = ({ strokeColor, iconClass, size }) => {
    return (
        <svg width={size} height={size} className={iconClass}  viewBox={`0 0 ${16} ${19}`}  fill="none" xmlns="http://www.w3.org/2000/svg">
