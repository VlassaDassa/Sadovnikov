...
const IconTwoPerson: React.FC<IconItem> = ({ strokeColor, fillColor, iconClass, size }) => {
    return (
        <svg width={size} height={size} viewBox={`0 0 ${20} ${20}`} className={iconClass}  fill="none" xmlns="http://www.w3.org/2000/svg">
